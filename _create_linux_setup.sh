...
if [ "${new_base}" == "" ];  then te_sel 0 0; te_last; fi
if [ "${new_base}" == "0" ]; then te_sel 0 0; te_last; fi
if [ "${new_base}" == "1" ]; then te_min ; te_last; fi
if [ "${new_base}" == "2" ]; then te_max ; te_last; fi
if [ "${new_base}" == "g" ]; then te_sel 1 0 ; te_last; fi
if [ "${new_base}" == "a" ]; then te_sel 0 1 ; te_last; fi
te_base
}
