...
@if %LABTOOL_AVAILABLE%==1 (
  ...
  start /max powershell vivado_lab -source ../scripts/script_main.tcl  -mode batch -notrace -tclargs --run_te_procedure "TE::TESTER::external_start" --boardpart %PARTNUMBER%
) else (
  start /max powershell vivado -source ../scripts/script_main.tcl  -mode batch -notrace -tclargs --run_te_procedure "TE::TESTER::external_start" --boardpart %PARTNUMBER%
)
