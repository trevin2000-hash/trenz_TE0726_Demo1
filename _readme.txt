  ...
  Edit "design_basic_settings.cmd" with text editor:
    Set your vivado installation path for edit: 
      ...
      In this example the it search in 
        C:\Xilinx\Vivado\2020.2 for VIVADO
        C:\Xilinx\Vitis\2020.2 for SDK (optional for some functionality, HSI/SDK)
        C:\Xilinx\Vivado_Lab\2020.2 for VIVADO Labtools (optional for programming only)
...
2.(optional) Create Vivado Project on Linux use instructions from option 1 of:
  ...
  Edit "design_basic_settings.sh" with text editor:
    Set your vivado installation path for edit: 
      ...
      @set VIVADO_VERSION=2020.2
      In this example the it search in 
        /opt/Vivado/2020.2 for VIVADO
        /opt/Vitis/2020.2 for SDK (optional for some functionality, HSI/SDK)
        /opt/Vivado_Lab/2020.2 for VIVADO Labtools (optional for programming only)
